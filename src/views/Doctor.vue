...
<template>
    ...
    <form class="drform" v-on:submit="register" @submit.prevent ="getFormValues">
        ...
        <p style=" color:crimson "><b> {{ dr_data.emailError }} </b></p>
    ...
    export default {
        ...
        methods:{
            ...
            async register(){
                ...
                try{
                let result =  await axios.post(import.meta.env.VITE_APIURL+"/doctor/signup",formData)
                    .then((res)=>{
                        console.log(res);
                    ...
                    .catch((err)=>{
                        console.log(err);
                        this.dr_data.emailError = err.response.data.email;
                        if(!this.dr_data.emailError){
                            alert("Pelase Enter Requred Data....");
                            this.$router.push({path: '/doctor/signup'});
                        }
                    })
                }
                catch(err){
