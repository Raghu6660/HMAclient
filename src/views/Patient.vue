...
<template>
    ...
    height: 100vh; background-size: cover">
        ...
        <form class="paform" v-on:submit="register" @submit.prevent ="getFormValues">
            ...
            <p style=" color:crimson "><b> {{ pa_data.emailError }} </b></p>
    ...
    export default {
        ...
        methods:{
            ...
            async register(){
                ...
                formData.append('mobile', this.pa_data.mobile);
                ...
                try{
                let result =  await axios.post(import.meta.env.VITE_APIURL+"/patient/signup",formData)
                    .then((res)=>{
                        console.log(res);
                    ...
                    .catch((err)=>{
                        console.log(err);
                        this.pa_data.emailError = err.response.data.email;
                        if(!this.pa_data.emailError){
                            alert("Pelase Enter Requred Data....");
