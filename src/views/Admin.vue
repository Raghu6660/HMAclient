...
<template>
 <div class="image" style="background-image: url('https://www.shutterstock.com/image-photo/young-practitioner-doctor-working-clinic-260nw-796833925.jpg');
    ...
    <form class="adminform" v-on:submit="register" @submit.prevent ="getFormValues">
        ...
        <p style=" color:crimson "><b> {{ user_data.emailError }} </b></p>
    ...
    export default {
        ...
        methods:{
            ...
            async register(){
                ...
                try{
                let result =  await axios.post(import.meta.env.VITE_APIURL+"/admin/signup",formData)
                    .then((res)=>{
                        console.log(res);
                    ...
                    .catch((err)=>{
                        this.user_data.emailError = err.response.data.errors.email;
                        if(!this.user_data.emailError){
