...
<template>
    ...
    <div>
      <form class="loginform" v-on:submit="auth" @submit.prevent ="getFormValues">
        ...
        <p style=" color:crimson "><b> {{ admin_data.emailError }} </b></p>
        <input type="password" v-model="admin_data.password" placeholder="Password" /><br><br>
        <p style=" color:crimson"><b> {{ admin_data.passwordError }} </b></p>
    ...
    methods:{
      ...
      try{
        ...
        // console.log(this.admin_data.password);
          let result = await axios.post(import.meta.env.VITE_APIURL+"/admin",{
          ...
          .then((res)=>{
                ...
                if (data.data.admin._id) {
                  ...
                  this.admin_data.email = data.data.admin.email;
                  ...
                  localStorage.setItem('photo', this.admin_data.photo);
                  localStorage.setItem('email', this.admin_data.email);
                }
